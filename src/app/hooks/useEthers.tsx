    ...
    const initialize = async () => {
      if (window?.ethereum) {
        ...
        if(account){
          ...
          const stackingContractInstance = new Contract(process.env.NEXT_PUBLIC_CONTRACT_ADDRESS!, StackingContract.abi, signer)
          setStackingContract(stackingContractInstance);
          
          const tokenContractInstance = new Contract(process.env.NEXT_PUBLIC_TOKEN_CONTRACT_ADDRESS!, TokenContract.abi, signer)
